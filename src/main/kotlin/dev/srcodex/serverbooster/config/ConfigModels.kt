...
data class ChunkOptimizerConfig(
    ...
    val unloadChunksInactiveTimeout: Int,
    val unloadChunksMinDistance: Int,
    val unloadChunksSpawnRadius: Int,
    val unloadChunksActivityDecay: Int,
    val unloadChunksLog: Boolean,
    val unloadChunksDebug: Boolean,
